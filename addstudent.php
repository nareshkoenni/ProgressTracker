...
<div class="navbar">
 ...
 <!-- <a style="float:left"  class="navbar-brand" href="#">
  ...
  <div align="center">
      <form name="adddonationform" action="addStudentProcess.php" method="post" style="text-align:center;background-color:white;width:30%; border: 1px #57B846;box-sizing: border-box;">
  
  <h2 style="margin:0 auto;width:87%;"><center>New Student</center></h2>
  <div class="container">
      <br/><br/>
      <input   placeholder="Name" type="text" name="name" required>
   
      <br/><br/>
      <input  type="text" placeholder="Reg No" name="regnum"  required>
    <br/>
    <br/>
    <input   placeholder="Dept/year" type="text" name="dept" required>
    <br/>
    <br/>
