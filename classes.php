...
<div class="navbar">
 ...
 <!-- <a style="float:left"  class="navbar-brand" href="#">
  ...
  <h1 align="center" style="color:white;">Exercises</h1>
  
  <h4 align="right" > <a href='addExercise.php' style="color:white;">Add Exercise</a></h4>
<table id="customers" style="text-align:center;" align="center">
  <tr>
    <th>ID</th>
    <th>Name</th>
    <th>Assign Student</th>
    <th>Mark Student Completion</th>
    <th>Edit</th>
    <th>Delete</th>
  </tr>
...
?>        
	...
	<tr>
		...
		<td><?php echo $row["class_name"] ;?></td>
         <td><a href='assignStudent.php?id=<?php echo $row["id"] ;?>'>Assign</a></td>
        <td><a href='editStudentCompletion.php?id=<?php echo $row["id"] ;?>'>Edit Completion</a></td>
        <td><a href='exerciseedit.php?id=<?php echo $row["id"] ;?>'>EDIT</a></td>
        <td><a href='exercisedeleteprocess.php?id=<?php echo $row["id"] ;?>'>DELETE</a></td>
