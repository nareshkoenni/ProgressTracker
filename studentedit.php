...
<div class="navbar">
 ...
 <?php
    include 'dbcon.php'; 
    $id=$_GET["id"];
    $sql = "SELECT id, student_name, reg_no,department FROM students where id=$id";
    $result = mysqli_query($conn, $sql);
     
    if($row1 = mysqli_fetch_assoc($result)) {
       
?>     
      <form name="adddonationform" action="studenteditprocess.php" method="post" style="text-align:center;background-color:white;width:30%; border: 1px #57B846;box-sizing: border-box;">
  
  <h2 style="margin:0 auto;width:87%;"><center>Edit Student's</center></h2>
  <div class="container">
      <br/><br/>
      <input   placeholder="Name" type="hidden" name="id" value="<?php echo $row1["id"] ;?>" >
   
      <input   placeholder="Name" type="text" name="name" value="<?php echo $row1["student_name"] ;?>" required>
   
      <br/><br/>
      <input  type="text" placeholder="Reg No" name="reg_no"  value="<?php echo $row1["reg_no"] ;?>" required>
    <br/>
    <br/>
    <input  type="text" placeholder="Dept/year" name="dept" value="<?php echo $row1["department"] ;?>" required>
    <br/>
    <br/>
   ...
   <button  style="background-color:#003366;" type="submit"><b>UPDATE</b></button>
